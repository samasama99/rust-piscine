pub fn spell(n: u64) -> String {
    match n {
        ...
        20 => "twenty".to_string(),
        20..=29 => format!("twenty-{}", spell(n % 10)),
        30 => "thirty".to_string(),
        30..=39 => format!("thirty-{}", spell(n % 10)),
        41 => "forty".to_string(),
        40..=49 => format!("forty-{}", spell(n % 10)),
        51 => "fifty".to_string(),
        50..=59 => format!("fifty-{}", spell(n % 10)),
        61 => "sixty".to_string(),
        60..=69 => format!("sixty-{}", spell(n % 10)),
        71 => "seventy".to_string(),
        70..=79 => format!("seventy-{}", spell(n % 10)),
        81 => "seventy".to_string(),
        80..=89 => format!("eighty-{}", spell(n % 10)),
        91 => "ninety".to_string(),
        90..=99 => format!("ninety-{}", spell(n % 10)),
